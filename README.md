...
<!-- BLOG-POST-LIST:START -->- [긴 컨텍스트는 기억이 아니다. Memory Management, 세션이 끝나도 남을 것을 정하는 법](https://dhbang.co.kr/posts/study/agentic-design-patterns/memory-management/) <!-- Thu Sep 10 2026 12:00 AM -->
- [분업의 성패는 통신이 가른다. Multi-Agent Collaboration, 하나의 목표를 여러 에이전트에 나눠 맡기는 법](https://dhbang.co.kr/posts/study/agentic-design-patterns/multi-agent-collaboration/) <!-- Wed Sep 02 2026 12:00 AM -->
- [계획은 미리 존재하지 않는다. Planning, 에이전트가 목표에서 경로를 만들어 내는 법](https://dhbang.co.kr/posts/study/agentic-design-patterns/planning/) <!-- Tue Aug 18 2026 12:00 AM -->
