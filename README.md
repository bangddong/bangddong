AI 에이전트 Harness를 탐구하는 백엔드 개발자 **방동현**입니다.
...
<!-- BLOG-POST-LIST:START -->- [분업의 성패는 통신이 가른다. Multi-Agent Collaboration, 하나의 목표를 여러 에이전트에 나눠 맡기는 법](https://dhbang.co.kr/posts/study/agentic-design-patterns/multi-agent-collaboration/) <!-- Wed Sep 02 2026 12:00 AM -->
